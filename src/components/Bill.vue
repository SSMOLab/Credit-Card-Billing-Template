<template>
  <div class="flex  items-center border-t  border-dashed break-inside  py-1 break-inside border-black">
    <div class="flex text-xs flex-col border-r  border-dashed mx-1 border-black">
      ...
      <div class="flex items-center text-xs  justify-around">
        <span>
          ...
          <img width="100" v-for="(url, index) in bill.paymentBarcode" :key="index"
            src="../assets/img/address-barcode.png" class="mt-1 h-16 w-16" />
        </span>
        <div class="flex flex-col justify-end">
          <span v-for="(paid, index) in bill.paidBarcode" :key="index">
            ...
            <img src="../assets/img/address-barcode.png" width="100" class="h-16 w-16" />
          </span>
        </div>
      </div>
      <!--first-->
      ...
      <div class="flex justify-around">
        <img src="../assets/img/address-barcode.png" width="100" class="mt-2 h-16 w-16"
          v-for="(collection, index) in bill.collectionBarcode" :key="index" />
      </div>
    </div>
    <!-- 第二聯table -->
      ...
      <table class="break-words table-fixed text-center">
        ...
        <tr>
          <td v-for="(unit, index) in bill.user.money" :key="index">
            <p class="border-b-2 items-center justify-center flex h-6 border-black">
              {{ unit.unit }}
            </p>
